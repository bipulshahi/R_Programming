...
height = c(162,177,165,166,158)

df$height = height
df

weight = c(76,74,65,55,59)
cbind(df,weight)      #Will add weight only for this instance not on dataframe

#Add a row
tom = data.frame(Name = "Tom",Age = 22, Child = FALSE,height =140)
df = rbind(df,tom)
...
#Accessing the rank acording to magnitude of values
ranks = order(df$Age)
ranks
